...
const clinics: Clinic[] = [
  {
    ...
    specialties: ['Almindelig tandpleje', 'Implantologi', 'Æstetisk tandpleje', 'Invisalign']
  },
  {
    ...
    openingHours: 'Man-Fre: 07:30-18:00',
    image: '/images/abc_tandklinikgruppen.jpg',
    specialties: ['Almindelig tandpleje', 'Børnetandpleje', 'Tandregulering', 'Specialisttandpleje']
  }
]
              ...
              <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-8 text-center">
                  <p className="text-sm text-neutral-500">
                    Har du brug for hjælp til at vælge? <Link href="/kontakt" className="text-primary-600 hover:text-primary-500">Kontakt os</Link>
                  </p>
                </div>
              </Dialog.Panel>
            </Transition.Child>
