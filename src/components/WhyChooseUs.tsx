...
const treatments = [
  { name: 'Akutbesøg', href: '/behandlingar/akut-tandvard' },
  { name: 'Besøg hos tandhygiejnist', href: '/behandlingar/tandhygienist' },
  { name: 'Tandundersøgelse/årlig kontrol', href: '/behandlingar/tandundersokning' },
  { name: 'Tandblekning', href: '/behandlingar/tandblekning' },
  { name: 'Rodfyldning', href: '/behandlingar/rotfyllning' },
  { name: 'Tandplejeangst', href: '/behandlingar/tandvardsradsla' },
  { name: 'Tandregulering/Invisalign', href: '/behandlingar/tandreglering' },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div>
            <h2 className="text-3xl font-bold text-gray-900 mb-8 leading-tight">
              Behandlinger vi kan hjælpe dig med
            </h2>
            <div className="relative">
              <Image
                src="/images/Miljöfoton på kliniken (4).jpg"
                alt="Moderne tandplejemiljø - Art of Dent"
                width={500}
                height={375}
